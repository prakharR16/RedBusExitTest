...
public class SearchTest extends Base{
	...
	public void When_User_Enter_Valid_From_Valid_To_and_Valid_Date() throws Throwable {
		extentTest = extent.startTest("Valid When_User_Enter_Valid_From_Valid_To_and_Valid_Date Test");
	...
	public void When_User_Enter_Valid_From_InValid_To_and_Valid_Date() throws Throwable {
		extentTest = extent.startTest("Valid When_User_Enter_Valid_From_InValid_To_and_Valid_Date test");
	...
	public void When_User_Enter_Valid_From_Valid_To_and_InValid_Date() throws Throwable {
		extentTest = extent.startTest("Valid When_User_Enter_Valid_From_Valid_To_and_InValid_Date test");
